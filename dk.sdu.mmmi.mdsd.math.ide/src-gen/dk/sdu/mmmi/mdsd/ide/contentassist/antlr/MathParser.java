...
public class MathParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getExternalAccess().getParamsAssignment_4(), "rule__External__ParamsAssignment_4");
			builder.put(grammarAccess.getExternalAccess().getParamsAssignment_5_1(), "rule__External__ParamsAssignment_5_1");
			...
			builder.put(grammarAccess.getLetBindingAccess().getExpAssignment_5(), "rule__LetBinding__ExpAssignment_5");
			...
			builder.put(grammarAccess.getExternalUseAccess().getExpsAssignment_3(), "rule__ExternalUse__ExpsAssignment_3");
			builder.put(grammarAccess.getExternalUseAccess().getExpsAssignment_4_1(), "rule__ExternalUse__ExpsAssignment_4_1");
		}
	}
