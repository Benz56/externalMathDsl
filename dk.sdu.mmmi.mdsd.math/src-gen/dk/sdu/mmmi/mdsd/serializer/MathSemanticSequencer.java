...
public class MathSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (ref=[External|ID] exps+=Exp? exps+=Exp*)
	 * </pre>
	 */
	...
	protected void sequence_LetBinding(ISerializationContext context, LetBinding semanticObject) {
		if (errorAcceptor != null) {
			...
			if (transientValues.isValueTransient(semanticObject, MathPackage.Literals.LET_BINDING__EXP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MathPackage.Literals.LET_BINDING__EXP));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		...
		feeder.accept(grammarAccess.getLetBindingAccess().getExpExpParserRuleCall_5_0(), semanticObject.getExp());
		feeder.finish();
	}
	...
	protected void sequence_VariableUse(ISerializationContext context, VariableUse semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getVariableUseAccess().getRefBindingIDTerminalRuleCall_1_0_1(), semanticObject.eGet(MathPackage.Literals.VARIABLE_USE__REF, false));
		feeder.finish();
	}
