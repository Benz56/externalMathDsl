 ...
 *   <li>{@link dk.sdu.mmmi.mdsd.math.impl.ExternalUseImpl#getExps <em>Exps</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExternalUseImpl extends ExpressionImpl implements ExternalUse
{
  ...
  public EList<Expression> getExps()
  {
    if (exps == null)
    {
      exps = new EObjectContainmentEList<Expression>(Expression.class, this, MathPackage.EXTERNAL_USE__EXPS);
    }
    return exps;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MathPackage.EXTERNAL_USE__EXPS:
